...
with open(file_to_save, "w") as txt_file:
    ...
    ##txt_file.write("Arapahoe, Denver, Jefferson") this is an  example for writing to a file
...
## Get Candidate names in the election
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # If the candidate does not match any existing candidate...(if statament is add to the loop so we just get candidate list, not every row printed)
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # Add a vote to that candidate's count (make sure that this line is in line with if statment Out of the if statement but aligned with the for loop)
...
for candidate_name in candidate_votes:
    ...
    # 4. Print the candidate name and percentage of votes('vote_percentage' to covert to 2 decimal is 'vote_percentage:.2f' )
    ...
    # Winning Candidate and Winning Count Tracker, Declare a  new variables
winning_candidate = ""
winning_count = 0
...
## Writing the Election Results to a Text file (modify our code)
